...
for n in range(num_steps):
    ...
    ax.set_title(r'$u(t=$' + str(np.round(t, 2)) + r'$)$ for $N_t=$' + str(num_steps) + r', $N_x=$' + str(Nx) + r' and $N_y=$' + str(Ny))
    ...
    plt.pause(0.5)
    if n == num_steps // 2 - 1:
        plt.savefig('2D_Conv_Diff_FEM_t05_Nt%02d_Nx%03d.png' % (num_steps, Nx), bbox_inches='tight', dpi=300)
    elif n == num_steps - 1:
        plt.savefig('2D_Conv_Diff_FEM_t1_Nt%02d_Nx%03d.png' % (num_steps, Nx), bbox_inches='tight', dpi=300)
